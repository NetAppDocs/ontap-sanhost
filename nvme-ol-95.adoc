...
----
+
The following example shows the model names:
+
----
LPe36002-M64
LPe36002-M64
...
----
+
The following examples show the model descriptions:
+
----
...
----
+
The following example displays a driver version:
+
----
0:14.4.0.2
----
...
== Step 5: Verify your NVMe configuration
...
. Verify the following NVMe/FC settings on the Oracle Liniux 9.5 host:

.. Verify that "multipath" is set:
+
[source,cli]
----
...
----
+
The value `Y` verifies the that multipath paraemter is set.

.. Dispaly the subsystems:
+
[source,cli]
----
