...
summary: Install the Linux Host Utilities on a RHEL 9.2 host to manage FCP and iSCSI protocol operations with ONTAP LUNs.
---
= Configure RHEL 9.2 for FCP and iSCSI with ONTAP storage
:hardbreaks:
:toclevels: 1
:nofooter:
:icons: font
...
You can use multipathing with RHEL 9.2 to manage ONTAP LUNs.
...
The RHEL 9.2 with ONTAP storage release has the following known issue:
