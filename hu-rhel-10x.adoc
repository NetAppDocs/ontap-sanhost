...
summary: Install Linux Host Utilities on a RHEL 10.x host to manage FCP and iSCSI protocol operations with ONTAP LUNs.
---
= Configure RHEL 10.x for FCP and iSCSI with ONTAP storage
:hardbreaks:
:toclevels: 1
:nofooter:
:icons: font
...
You can use multipathing with RHEL 10.x to manage ONTAP LUNs.
...
include::_include/hu/linux-iscsi-configuration-rhel-10.adoc[]
