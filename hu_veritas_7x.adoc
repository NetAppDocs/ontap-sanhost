...
== Introduction
This document provides guidance on ONTAP SAN host configuration settings for Veritas Infoscale 7.4.1, 7.4.2, and 7.4.3 releases for Red Hat Enterprise Linux & Oracle Linux (RHCK based) platforms with FC, FCoE and iSCSI protocols.
