...
The following support is available for NVMe/FC host configuration for OL 8.7 with ONTAP: 

* Support for NVMe/TCP in addition to NVMe/FC. The NetApp plug-in in the native `nvme-cli` package displays ONTAP details for both NVMe/FC and NVMe/TCP namespaces. 
...
NVMe-OF host configuration for Oracle Linux 8.7 with ONTAP release has the following known issues:
