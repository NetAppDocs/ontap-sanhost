...
* <<restore-recommended-setting-slessp15sp6,Restore recommended settings for ONTAP LUNs>>

[[exclude-devices]]

include::_include/hu/blacklist-devices.adoc[]

[[restore-recommended-setting-slessp15sp6]]
include::_include/hu/restore-recommended-settings.adoc[]
