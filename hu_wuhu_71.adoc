...
Verify that your host and storage system configuration are supported before you install Windows Host Utilities for the <<supported-windows-versions-71,supported Windows Server>> host.
