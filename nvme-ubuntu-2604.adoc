...
The native inbox qla2xxx driver included in the Ubuntu 26.04 GA kernel has the latest upstream fixes. These fixes are essential for ONTAP support. 
...
The default iopolicy for NVMe-oF is set to queue-depth. To change the iopolicy to `round-robin`, you need to modify the udev rules file.
