...
.Before you begin
Learn how to configure NVMe over Fabrics (NVMe-oF) hosts for RHEL 8.4. For more support and feature information, see link:hu-nvme-rhel.html[ONTAP support and features^]. 

*NVMe-oF with RHEL 8.4 has the following known limitations:*
