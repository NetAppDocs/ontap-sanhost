...
* Both NVMe and SCSI traffic can be run on the same co-existent host. Therefore, in case of SCSI LUNs you can configure dm-multipath for SCSI mpath devices, whereas NVMe multipath might be used to configure NVMe-oF namespaces devices on the host.
