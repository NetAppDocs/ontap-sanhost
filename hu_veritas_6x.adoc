...
[.lead]
You can use ONTAP SAN host configuration settings for the Veritas Storage Foundation 6 series release for Red Hat Enterprise Linux and Oracle Linux (Red Hat Enterprise Kernel based) platforms with FC, FCoE and iSCSI protocols.
...
You must verify that your configuration meets the system requirements.  For more information, see the https://mysupport.netapp.com/matrix/imt.jsp?components=65623;64703;&solution=1&isHWU&src=IMT[Interoperability Matrix Tool^] and the Veritas HCL Matrix.
