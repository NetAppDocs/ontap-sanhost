...
= Using Oracle Linux 8.4 with NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1P
:nofooter:
...
NOTE: To configure Oracle Linux 8.4 RedHat Enterprise Kernel (RHCK), use the link:hu_rhel_82.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 8.4.
...
There are no known issues for Oracle Linux 8.4.

NOTE: For Oracle Linux (Red Hat compatible kernel) known issues, see the Known Issues section in the corresponding Red Hat Enterprise Linux release documentation.
