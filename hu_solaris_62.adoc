...
[.lead]
The Solaris Utilities enable you to connect a Solaris host to NetApp storage.
...
Review the link:hu_solaris_62_cmd.html[sample command reference] for end-to-end validation of the Solaris host utilities installation.