...
summary: Install the Linux Host Utilities on a RHEL 7.9 host to manage FCP and iSCSI protocol operations with ONTAP LUNs.
---
= Configure RHEL 7.9 for FCP and iSCSI with ONTAP storage
:hardbreaks:
:toclevels: 1
:nofooter:
:icons: font
...
You can use multipathing with RHEL 7.9 to manage ONTAP LUNs.
...
The RHEL 7.9 with ONTAP storage release has the following known issue:
