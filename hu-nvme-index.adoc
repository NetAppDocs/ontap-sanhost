...
.RHEL support and features
[%collapsible%open]
====
The table shows ONTAP features supported by ONTAP versions and SAN host operating systems for RHEL:

[cols="40,30,30",options="header"]
|===

|ONTAP feature | Supported RHEL SAN hosts | ONTAP version
...
* 8.10, 8.9, 8.8, 8.7, 8.6, 8.5, 8.4, 8.8, 8.2 
...
|ONTAP feature | Supported RHEL SAN hosts 
...
a|* 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0 
|===
====
// End snippet

// Start snippet: collapsible block (open on page load)
.Rocky Linux support and features
[%collapsible%open]
====
The table shows ONTAP features supported by ONTAP versions and SAN host operating systems for Rocky Linux:

[cols="40,30,30",options="header"]
|===

|ONTAP feature | Supported Rocky Linux SAN hosts | ONTAP version

|*Secure in-band authentication for NVMe/TCP* 
a|* 10.0 
* 9.6, 9.5 |Support begins with 9.12.1
|*NVMe/TCP in addition to NVMe/FC* 

Provides ONTAP details for both NVMe/FC and NVMe/TCP namespaces using the native `nvme-cli` package.
a|* 10.0
* 9.6, 9.5, 9.4, 9.3, 9.2, 9.1  
* 8.10, 8.9, 8.8, 8.7, 8.6, 8.5, 8.4, 8.8, 8.2 |Support begins with 9.10.1
|*NVMe/TCP is a fully supported enterprise feature* 
a|* 10.0 
* 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0 |Support begins with 9.10.1 
|*NVMe and SCSI traffic supported on the same host*

Use dm-multipath for SCSI LUNs and NVMe multipath for NVMe-oF namespaces.
a|* 10.0 
* 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0 
* 8.10, 8.9, 8.8, 8.7, 8.6, 8.5, 8.4, 8.3, 8.2 |Support begins with 9.4 
|===
...
|ONTAP feature | Supported Rocky Linux SAN hosts 
|*Native NVMe multipathing is always enabled* 
