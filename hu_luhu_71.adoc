...
* You must install the host bus adapter (HBA) management packages provided by the vendors on their websites.
+
...
. Download the either the 32-bit or 64-bit Linux Unified Host Utilities software package from the NetApp Support Site to your host.
