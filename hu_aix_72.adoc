...
The AIX storage stack does not perform an automatic rescan of the LUNS.  After a planned failover or AUFO event, you must perform the following AIX host remediation steps to discover the LUN paths from the new primary cluster.
