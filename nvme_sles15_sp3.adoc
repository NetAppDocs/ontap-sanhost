...
[NOTE]
====
The above nvme-cli MU package includes the following now:

*	NVMe/FC auto-connect scripts - Included natively in the nvme-cli now. Threfore, you no longer need to install the Broadcom/QLogic auto-connects separately on the SLES15 SP3 host:
+
----
