...
* You must review the link:https://docs.netapp.com/us-en/ontap-sanhost/hu_wuhu_71_rn.html[Release Notes for Windows Host Utilities] to check for known problems. The Release Notes include a list of Known issues.
