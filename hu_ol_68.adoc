...
NOTE: To configure Oracle Linux 6.8 Red Hat Compatible Kernel (RHCK), use the link:hu_rhel_68.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 6.8.

== Known issues

There are no known issues for the Oracle Linux 6.8 with ONTAP release.

NOTE: For Oracle Linux RHCK known issues, see the link:hu_rhel_68.html#known-problems-and-limitations[known issues] for RHEL 6.8.
