...
+
You can use the https://mysupport.netapp.com/matrix/imt.jsp?components=65623;64703;&solution=1&isHWU&src=IMT[Interoperability Matrix Tool^] to verify your configuration.
