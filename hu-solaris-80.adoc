...
. Configure the host parameters for your "MPxIO" or "Veritas DMP" environment using the `/opt/NTAP/SANToolkit/bin/host_config` command based on the following multipath stack from the command reference:
+
