...
* LimTransferSize=1
+
The LimTransferSize parameter is automatically set to "1" when you install Windows Host Utilities 7.2. After installation, you need to manually change LimTransferSize to "0" and reboot the server.
