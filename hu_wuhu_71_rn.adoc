...
Install the latest hotfixes before installing the Windows Host Utilities. Refer to the link:https://docs.netapp.com/us-en/ontap-sanhost/hu_wuhu_71.html#verify-your-host-and-storage-system-configuration[Windows Unified Host Utilities 7.1] document for your specific configuration hotfix requirements.
