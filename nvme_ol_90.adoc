...
. Install Oracle Linux 9.0 GA on the server. After the installation is complete, verify that you are running the specified Oracle Linux 9.0 GA kernel. 
+
----
# uname -r
----
...
. Verify the following NVMe/FC settings on the Oracle Linux 9.0 host:
+
----
