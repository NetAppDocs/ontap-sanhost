...
The Oracle Linux 9.3 OS recognizes ONTAP LUNs and automatically sets all configuration parameters correctly for both ASA and non-ASA configurations. You can further optimize performance for your host configuration with the following recommended settings.
...
NOTE: To configure Oracle Linux 9.3 Red Hat Enterprise Kernel (RHCK), use the link:hu_rhel_93.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 9.3.
