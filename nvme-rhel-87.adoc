...
.Before you begin
Learn how to configure NVMe over Fabrics (NVMe-oF) hosts for RHEL 8.7. For more support and feature information, see link:hu-nvme-rhel.html[ONTAP support and features^]. 
