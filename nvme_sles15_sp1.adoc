...
NVMe/FC is supported on ONTAP 9.6 or later for the following versions of SUSE Linux Enterprise Server:
...
+
For the current list of supported configurations and versions, see the link:https://mysupport.netapp.com/matrix/[NetApp Interoperability Matrix^].
