...
[.lead]
The release notes document contains the latest information for the Windows Unified Host Utilities 7.2 and 7.1 releases, including updates about new features, enhancements, and known issues. The document is updated when new information on using the Windows Host Utilities becomes available.
