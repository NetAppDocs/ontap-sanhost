...
= Using IBM AIX 7.1 with NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:nofooter:
...
== Installing the AIX Host Utilities
...
Following are some recommended parameter settings for NetApp ONTAP LUNs.  The critical parameters for ONTAP LUNs are set automatically after installing the NetApp Host Utilities Kit.
