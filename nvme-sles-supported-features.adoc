...
[.lead]
Features supported for host configuration with NVMe over Fabrics (NVMe-oF) vary based on your version of ONTAP and SUSE Linux Enterprise Server.
