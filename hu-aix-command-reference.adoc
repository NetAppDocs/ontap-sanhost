...
---
= Use AIX Host Utilities commands to verify ONTAP storage configuration
:hardbreaks:
:toclevels: 1
:nofooter:
:icons: font
...
[role="tabbed-block"]
=====
.AIX Host Utilities 8.0
--
Use the AIX Host Utilities 8.0 sample command reference:

* <<all-host-initiators-mapped-to-host-80,List all host initiators mapped to host>>
* <<all-luns-mapped-to-host-80,List all LUNs mapped to host>>
* <<mapped-to-host-from-svm-80,List all LUNs mapped to host from a given SVM>>
* <<attributes-of-lun-80,List all attributes of a given LUN mapped to host>>
* <<attributes-by-host-device-filename-80,List ONTAP LUN attributes by host device filename>>
* <<svm-target-lif-wwpns-80,List all SVM target LIF WWPNs attached to host>>

[[all-host-initiators-mapped-to-host-80]]
...
[[attributes-by-host-device-filename-80]]
...
--
Use the AIX Host Utilities 6.1 sample command reference:

* <<all-host-initiators-mapped-to-host,List all host initiators mapped to host>>
* <<all-luns-mapped-to-host,List all LUNs mapped to host>>
* <<mapped-to-host-from-svm,List all LUNs mapped to host from a given SVM>>
* <<attributes-of-lun,List all attributes of a given LUN mapped to host>>
* <<attributes-by-host-device-filename,List ONTAP LUN attributes by host device filename>>
* <<svm-target-lif-wwpns,List all SVM target LIF WWPNs attached to host>>

[[all-host-initiators-mapped-to-host]]
.List all host initiators mapped to host
...
[[attributes-by-host-device-filename]]
.List ONTAP LUN attributes by host device filename
You can retrieve a list of ONTAP LUN attributes by specifying a host device filename.
