...
. Download a copy of the compressed file containing the Host Utilities from the link:https://mysupport.netapp.com/site/products/all/details/hostutilities/downloads-tab/download/61343/8.0/downloads[NetApp Support Site^] to a directory on your host.
+
[role="tabbed-block"]
====
.SPARC CPU
