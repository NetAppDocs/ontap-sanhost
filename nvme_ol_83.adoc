...
Refer to the http://mysupport.netapp.com/matrix3[NetApp Interoperability Matrix Tool (IMT)^] for the current list of supported configurations.
...
The NVMe-oF host configuration for OL 8.3 with ONTAP release has the following known issues:
