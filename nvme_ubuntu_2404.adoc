...
NVMe/TCP doesn't support the auto-connect functionality. Instead, you can discover the NVMe/TCP subsystems and namespaces by manually performing NVMe/TCP `connect` or `connect-all`.
