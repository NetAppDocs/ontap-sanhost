...
You can generate the JSON file using `-o` option. Refer to the link:https://docs.netapp.com/us-en/ontap/concepts/manual-pages.html[ONTAP man pages^] for more syntax options.
