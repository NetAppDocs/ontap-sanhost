...
.  The native inbox qla2xxx driver included in the OL 8.8 GA kernel has the latest fixes essential for ONTAP support. Verify that you are running the supported adapter driver and firmware versions:
+
----
...
|Oracle Linux 8.8 NVMe-oF hosts create duplicate PDCs
