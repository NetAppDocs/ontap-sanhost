...
This document describes how to configure NVMe over Fabrics (NVMe-oF) hosts for Red Hat Enterprise Linux (RHEL) 9.6. For additional support and feature information, refer to link:hu-nvme-index.html[NVME-oF Overview^]. The following are known limitations for RHEL 9.6:
...
Use the following procedure to validate that your RHEL 9.6 system meets the software requirements and verify the NVMe package installations and host configuration.
