...
== What's New 
The Linux Unified Host Utilities 7.1 release contains the following new features and enhancements:
...
The Linux Unified Host Utilities 7.1 release has the following known problems and limitations.
