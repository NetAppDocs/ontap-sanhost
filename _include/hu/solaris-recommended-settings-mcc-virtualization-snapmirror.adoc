. Change the default settings for MetroCluster, Oracle Solaris virtualization, or SnapMirror active sync if, these options are included in you storage configuration.
+
[role="tabbed-block"]
=====
.MetroCluster
