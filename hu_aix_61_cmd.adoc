...
= AIX  Host Utilities 6.1 sample command reference
:toc: macro
:hardbreaks:
:toclevels: 1
:nofooter:
...
You can use the AIX Host Utilities 6.1 sample command reference for an end-to-end validation of the NetApp storage configuration using the host utilities tool.
