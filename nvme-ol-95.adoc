...
** Beginning with ONTAP 9.12.1, support for secure in-band authentication is introduced for NVMe/TCP. You can use secure in-band authentication for NVMe/TCP, beginning with Oracle Linux 9.4.
...
** SAN booting using the NVMe-oF protocol is not supported for Oracle Linux 9.4, 9.3, 9.2, 9.1, and 9.0.
