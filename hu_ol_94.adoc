...
[.lead]
You can use the ONTAP SAN host configuration settings to configure Oracle Linux (OL) 9.4 with ONTAP as the target.
...
NOTE: To configure Oracle Linux 9.4 Red Hat Enterprise Kernel (RHCK), use the link:hu_rhel_94.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 9.4.
