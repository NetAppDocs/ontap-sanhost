...
= Using CentOS 7.5 with NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:nofooter:
...
For CentOS (Red Hat compatible kernel) known issues, see the link:hu_rhel_75.html#known-problems-and-limitations[known issues] for Red Hat Enterprise Linux (RHEL) 7.5.
