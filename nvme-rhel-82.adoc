...
.Before you begin
Learn how to configure NVMe over Fabrics (NVMe-oF) hosts for RHEL 8.2. For more support and feature information, see link:hu-nvme-rhel.html[ONTAP support and features^]. 

*NVMe-oF with RHEL 8.2 has the following known limitations:*
