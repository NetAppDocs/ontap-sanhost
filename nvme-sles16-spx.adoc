...
.NVMe/FC 
--
The following example outputs show a namespace hosted on a two-node ONTAP controller for AFF, FAS, ASA, or ASA r2 system with NVMe/FC.
...
.NVMe/TCP 
--
The following example outputs show a namespace hosted on a two-node ONTAP controller for AFF, FAS, ASA, or ASA r2 systems with NVMe/TCP.
...
(vserver nvme subsystem controller show)
        ...
        Initiator Transport Address: 192.168.38.20
                    Host Identifier: 4c4cssss0035ssss804bb2cxxxx44d33
