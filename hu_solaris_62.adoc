...
[.lead]
The Solaris Host Utilities assist you in managing ONTAP storage attached to a Solaris host. The Solaris Host Utilities support several Solaris environments and multiple transport protocols.
