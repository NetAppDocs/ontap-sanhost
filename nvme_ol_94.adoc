...
>>>>>>> 23c92d9e8d76a2785aace0f33417fae7854bbde7
...
+
[NOTE]
Beginning with Oracle Linux 9.4, the default setting for the NVMe/TCP `ctrl_loss_tmo timeout` is turned off and there are no limits on the number of retries (indefinite retry). 
