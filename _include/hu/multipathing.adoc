...
+
NOTE: The default multipath parameters loaded from an empty, zero-byte `/etc/multipath.conf` file support ASA and non-ASA configurations for AFF and FAS systems and cloud storage.
+
[role="tabbed-block"]
====
.ASA configuration
