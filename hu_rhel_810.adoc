---
sidebar: sidebar
permalink: hu-rhel-8.html
keywords: host utilities, red hat, rhel, linux, 8.x, netapp, ontap, rhel 
...
The RHEL 8.x with ONTAP storage release has the following known issues:
