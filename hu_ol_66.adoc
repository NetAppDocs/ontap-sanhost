...
NOTE: To configure Oracle Linux 6.6 RedHat Enterprise Kernel (RHCK), use the link:hu_rhel_66.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 6.6.
