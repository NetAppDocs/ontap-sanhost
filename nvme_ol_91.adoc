...
.  The native inbox qla2xxx driver included in the OL 9.1 GA kernel has the latest upstream fixes essential for ONTAP support. Verify that you are running the supported adapter driver and firmware versions:
+
----
...
NVMe-oF host configuration for OL 9.1 with ONTAP release has the following known issues:
