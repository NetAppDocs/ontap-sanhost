...
summary: Install the Linux Host Utilities on a RHEL 8.0 host to manage FCP and iSCSI protocol operations with ONTAP LUNs.
---
= Configure RHEL 8.0 with FCP and iSCSI for ONTAP storage
:hardbreaks:
:toclevels: 1
:nofooter:
:icons: font
