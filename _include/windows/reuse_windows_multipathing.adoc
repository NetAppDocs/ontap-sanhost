...
On a Windows system, the two main components to any MPIO solution are a DSM and the Windows MPIO. MPIO is not supported for Windows XP and Windows Vista running in a Hyper- V virtual machine.
