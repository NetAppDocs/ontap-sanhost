...
NOTE: To configure Oracle Linux 7.2 RedHat Enterprise Kernel (RHCK), use the link:hu_rhel_72.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 7.2.

== Known Problems and Limitations

There are no known issues for Oracle Linux 7.2.

NOTE: For Oracle Linux (Red Hat compatible kernel) known issues, see the link:hu_rhel_72.html#known-problems-and-limitations[known issues] for Red Hat Enterprise Linux (RHEL) 7.2.
