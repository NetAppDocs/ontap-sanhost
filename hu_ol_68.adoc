...
NOTE: For Oracle Linux (Red Hat compatible kernel) known issues, see the link:hu_rhel_68#known-problems-and-limitations[known issues] for Red Hat Enterprise Linux (RHEL) 6.8.
