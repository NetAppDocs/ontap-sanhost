...
You can use the AIX Host Utilities 6.1 command reference for for an end-to-end validation of the NetApp storage configuration using the host utilities tool.
