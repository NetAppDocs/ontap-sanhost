...
[NOTE]
Linux Unified Host Utilities support NVMe over Fibre Channel (NVMe/FC). NVMe over TCP (NVMe/TCP) host protocol is not supported.
...
== Recommended driver with Linux kernel
...
Refer to the link:hu_luhu_71_cmd.html[sample command reference] for end-to-end validation of your storage configuration.
