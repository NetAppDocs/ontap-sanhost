...
* Beginning with 7.0U3c and later, NVMe/TCP feature is supported for ESXi Hypervisor.
* Beginning with ONTAP 9.10.1 and later, NVMe/TCP feature is supported for ONTAP.
