...
Refer to the http://mysupport.netapp.com/matrix3[NetApp InterOperability Matrix Tool (IMT)^] for exact details regarding current list of supported configurations.

== Enable NVMe/FC with Oracle Linux 8.3

.Steps

. Install Oracle Linux 8.3 GA on the server. After the installation is complete, verify that you are running the specified Oracle Linux 8.3 GA kernel. See the https://mysupport.netapp.com/matrix/[NetApp Interoperability Matrix Tool^] for the most current list of supported versions.
+
...
+
----
#cat /etc/nvme/hostnqn http://nqn.2014-08.org/[_nqn.2014-08.org.nvmexpress:uuid:446c21ab-f4c1-47ed-9a8f-1def96f3fed2_]

::> vserver nvme subsystem host show -vserver vs_coexistance_2 
Vserver   Subsystem      Host NQN 
------- --------- ---------------------------------------------------------- 
vs_coexistance_2 nvme_1 http://nqn.2014-08.org/[nqn.2014-08.org].nvmexpress:uuid:446c21ab-f4c1-47ed-9a8f-1def96f3fed2
----
+
[NOTE]
...
. Verify that you are running the supported adapter driver and firmware versions.The native inbox qla2xxx driver included in the OL 8.3 GA kernel has the latest upstream fixes essential for ONTAP support. :
