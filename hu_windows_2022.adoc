...
NOTE: Go to the link:https://www.catalog.update.microsoft.com/Search.aspx?q=Update+Windows+Server+2022[Microsoft Update Catalog 2022^] website to obtain and install the required Windows hotfixes for your version of Windows.
