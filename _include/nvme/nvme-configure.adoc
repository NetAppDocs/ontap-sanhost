...
The NVMe/TCP protocol does not support the auto-connect operation. You need to manually perform the NVMe/TCP connect or connect-all operations to discover the NVMe/TCP subsystems and namespaces.
