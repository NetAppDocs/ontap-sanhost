...
The native inbox qla2xxx driver included in the RHEL 9.2 GA kernel has the latest upstream fixes. 

.Steps

. These fixes are essential for ONTAP support. Verify that you are running the supported adapter driver and firmware versions:
+
----
