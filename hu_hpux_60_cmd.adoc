...
[.lead]
You can use the HP-UX Unified Host Utilities 6.0 sample command reference for an end-to-end validation of the NetApp storage configuration using the Host Utilities tool.
