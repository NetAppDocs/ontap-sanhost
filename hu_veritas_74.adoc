---
sidebar: sidebar
permalink: hu_veritas_7.html
keywords: host utilities, veritas, infoscale, 7.x, netapp, ontap, sanhost, iscsi, red, hat linux, oracle, linux
summary: Provides guidance on ONTAP SAN host configuration settings for the Veritas Infoscale 7 series release
---

= Using Veritas Infoscale 7 for Linux with NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:nofooter:
...
== Introduction
This document provides guidance on ONTAP SAN host configuration settings for the Veritas Infoscale storage foundation 7 series release for Red Hat Enterprise Linux & Oracle Linux (RHCK based) platforms with FC, FCoE and iSCSI protocols.
