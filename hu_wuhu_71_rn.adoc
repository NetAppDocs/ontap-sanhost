...
Refer to the link:https://docs.netapp.com/us-en/ontap-sanhost/hu_wuhu_72.html[Windows Host Utilities documentation] for your specific configuration hotfix requirements.
