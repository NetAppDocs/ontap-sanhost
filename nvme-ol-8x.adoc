...
* For 8.2 and earlier versions, round-robin load balancing is not enabled by default for NVMe multipathing. To enable this functionality, write a udev rule.
