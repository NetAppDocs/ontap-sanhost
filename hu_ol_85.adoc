...
NOTE: To configure Oracle Linux 8.5 RedHat Enterprise Kernel (RHCK), use the link:hu_rhel_85.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 8.5.
