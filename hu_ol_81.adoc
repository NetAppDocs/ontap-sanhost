...
NOTE: To configure Oracle Linux 8.1 RedHat Enterprise Kernel (RHCK), use the link:hu_rhel_81.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 8.1.

== Known Problems and Limitations

There are no known issues for Oracle Linux 8.1.

NOTE: For Oracle Linux (Red Hat compatible kernel) known issues, see the link:hu_rhel_81#known-problems-and-limitations[known issues] for Red Hat Enterprise Linux (RHEL) 8.1.
