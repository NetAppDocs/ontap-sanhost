...
summary: Install the Linux Host Utilities on a RHEL 10 host to manage FCP and iSCSI protocol operations with ONTAP LUNs.
---
= Configure RHEL 10 for FCP and iSCSI with ONTAP storage
:hardbreaks:
:toclevels: 1
:nofooter:
:icons: font
...
You can use multipathing with RHEL 10 to manage ONTAP LUNs.
