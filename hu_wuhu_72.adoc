...
The Host Utilities installation package must be in a path that is accessible by the Windows host. Follow the instructions for installing the Host Utilities interactively to obtain the installation package. The system automatically reboots when the installation is complete.
...
|120
|When MPIO support is specified and your server is Windows Server 2022, Windows Server 2012 R2,
...
|30
|When your server is Windows Server 2022, Windows Server 2012 R2,
...
== NVMe parameters
You need to enable the following NVMe Emulex driver parameters when installing WUHU 7.2:
