...
NOTE: To configure Oracle Linux 6.10 RedHat Enterprise Kernel (RHCK), use the link:hu_rhel_610.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 6.10.
