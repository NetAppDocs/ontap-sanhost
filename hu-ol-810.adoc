...
NOTE: To configure Oracle Linux 8.10 Red Hat Compatible Kernel (RHCK), use the link:hu_rhel_810.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 8.10.
