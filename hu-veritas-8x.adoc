...
.Before you begin
Ensure that your configuration meets the system requirements. See the link:https://mysupport.netapp.com/matrix/#welcome[Interoperability Matrix Tool^] and the Veritas HCL Matrix.
...
----
. Verify that the tunables settings are correct:
+
[source,cli]
----
# vxdmpadm gettune
