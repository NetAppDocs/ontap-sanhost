...
NOTE: To configure Oracle Linux 6.4 RedHat Enterprise Kernel (RHCK), use the link:hu_rhel_64.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 6.4.

== Known issues

The Oracle Linux 6.4 with ONTAP has the following known issues:
