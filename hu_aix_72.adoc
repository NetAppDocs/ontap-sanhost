...
| 1307653 | Seeing I/O issues on VIOS 3.1.1.10 during SFO faults and straight io | On VIOS 3.1.1 IO failures may be seen on NPIV client disk which are backed by 16/32Gb FC adapters.  Also, a vfchost driver may get into a state where it stops processing I/O requests from the client.
