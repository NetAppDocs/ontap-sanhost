...
You first install the relevant operating system host utility software package, which includes the SAN Toolkit. If it's supported by your SAN configuration, you can also configure your host to use SAN booting. You then verify the multipath settings for the ONTAP LUNs and apply the recommended settings. 
