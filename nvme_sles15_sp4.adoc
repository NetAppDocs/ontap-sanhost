...
Beginning with ONTAP 9.12.1 and later, secure, in-band authentication is supported over NVMe/TCP between your SLES 15 SP4 host and your ONTAP controller.
