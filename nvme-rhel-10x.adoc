...
RHEL 10.1 sets the default iopolicy for NVMe-oF to `queue-depth`. If you are using RHEL 10.0 and want to change the iopolicy to `queue-depth`, modify the udev rules file as follows:
