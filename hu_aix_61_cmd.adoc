...
You can use the AIX Host Utilities sample command reference for an end-to-end validation of a NetApp storage configuration using the Host Utilities tool.
