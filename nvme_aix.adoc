...
** You do not need a separate Path Control Module (PCM), such as Host Utilities for AIX SCSI Multipath I/O (MPIO) support, for NVMe devices.
...
You need to verify that the host correctly reflects ONTAP namespaces. Run the following command to do so:
----
