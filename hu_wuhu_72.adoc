...
--
You can perform a quiet (unattended) installation of the new host utilities by entering the appropriate commands at the Windows command prompt.
...
You can use the host utilities installation program *Repair* option to update the HBA and Windows registry settings. You can remove the host utilities entirely, either interactively or from the Windows command line.
