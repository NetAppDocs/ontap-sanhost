...
Rocky Linux is a RHEL-compatible distribution and does not have a separate Linux Host Utilities package. Use the Linux Host Utilities package for the corresponding RHEL version.
