...
The following support is available for the NVMe-oF host configuration for RHEL 9.3 with ONTAP:
...
. The native inbox qla2xxx driver included in the RHEL 9.3 GA kernel has the latest upstream fixes essential for ONTAP support. Verify that you are running the supported adapter driver and firmware versions:
+
----
