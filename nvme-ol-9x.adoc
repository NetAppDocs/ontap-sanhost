...
----
+
NOTE: Beginning with ONTAP 9.16.1, NVMe/FV and NVMe/TCP report all optimized paths on ASA r2 systems.
+
[role="tabbed-block"]
=====
.NVMe/FC
...
// 2025 DEC 8, ONTAPDOC-3418, Oracle Linux 9.6 release
// 2026 April 6, ONTAPDOC3731