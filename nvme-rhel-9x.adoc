...
Learn how to configure NVMe over Fabrics (NVMe-oF) hosts for RHEL 9x. For more support and feature information, see link:nvme-rhel-supported-features.html[RHEL ONTAP support and features].
...
nvme	connect-all	-t	tcp	-w	192.168.31.15	-a	192.168.30.48
nvme	connect-all	-t	tcp	-w	192.168.31.15	-a	192.168.30.49	
----			
====
...
[subs=+quotes]
----
Device           Vserver                   Subsystem                 Namespace Path                                     NSID UUID                                   Size
---------------- ------------------------- ------------------------- -------------------------------------------------- ---- -------------------------------------- ---------
/dev/nvme0n1     vs_iscsi_tcp              Nvme1                     /vol/Nvmevol1/ns1                                  1    d8efef7d-4dde-447f-b50e-b2c009298c66   26.84GB
...
Secure in-band authentication is supported over NVMe/TCP between a RHEL 9x host and an ONTAP controller.
