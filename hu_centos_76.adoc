...
= Using CentOS 7.6 with NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:nofooter:
...
The CentOS 7.6 OS is compiled to recognize ONTAP LUNs and automatically set all configuration parameters correctly for both ASA and non-ASA configuration.
...
For CentOS (Red Hat compatible kernel) known issues, see the link:hu_rhel_76.html#known-problems-and-limitations[known issues] for Red Hat Enterprise Linux (RHEL) 7.6.
