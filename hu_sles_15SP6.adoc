...
[.lead]
You can use the ONTAP SAN host configuration settings to configure SUSE Linux Enterprise Server 15 SP6 with FCP or iSCSI for operation with ONTAP storage.   
...
The following example determines a WWID and adds it to a blacklist.
