...
[.lead]
You can use the Solaris Host Utilities 6.2 sample command reference for an end-to-end validation of the ONTAP storage configuration using the host utilities tool.
