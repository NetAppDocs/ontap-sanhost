...
. Create a SAN boot LUN by following the procedure in the link:https://docs.netapp.com/us-en/ontap/san-admin/provision-storage.html[Provision SAN storage documentation^].
