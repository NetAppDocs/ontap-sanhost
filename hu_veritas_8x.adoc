...
---
= Use Veritas Infoscale 8 for Linux with ONTAP
:hardbreaks:
:toclevels: 1
:nofooter:
:icons: font
...
[.lead]
You can use ONTAP SAN host configuration settings for the Veritas Infoscale storage foundation 8 series release for Red Hat Enterprise Linux and Oracle Linux (Red Hat Compatible Kernel based) platforms with FC, FCoE, and iSCSI protocols.
...
There are no known issues for the Veritas Infoscale 8 for Linux with ONTAP release.
