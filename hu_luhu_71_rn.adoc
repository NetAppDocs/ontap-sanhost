...
Bugs might have been fixed in a maintenance or patch release, see link:https://mysupport.netapp.com/site/bugs-online/product[NetApp Bugs Online] to learn which issues affect your installed systems.
