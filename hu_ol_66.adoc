...
.Before you begin
If you decide to use SAN booting, it must be supported by your configuration. You can use the https://mysupport.netapp.com/matrix/imt.jsp?components=74908;74907;71545;71546;69941;69939;69940;&solution=1&isHWU&src=IMT[Interoperability Matrix Tool^] to verify that your OS, HBA, HBA firmware and the HBA boot BIOS, and ONTAP version are supported.
...
NOTE: To configure Oracle Linux 6.6 Red Hat Enterprise Kernel (RHCK), use the link:hu_rhel_66.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 6.6.

== Known issues

There are no known issues for the Oracle Linux 6.6 with ONTAP release.

NOTE: For Oracle Linux (Red Hat compatible kernel) known issues, see the link:hu_rhel_66.html#known-problems-and-limitations[known issues] for Red Hat Enterprise Linux (RHEL) 6.6.
