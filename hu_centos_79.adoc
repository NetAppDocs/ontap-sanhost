...
NOTE: When you set the disable_changed_wwids multipath configuration parameter to YES, it disables access to the path device in the event of WWID change. Refer to the link:https://docs.centos.org/en-US/docs/[CentOS documentation] for more information.
