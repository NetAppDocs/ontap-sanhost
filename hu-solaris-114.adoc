...
====
+
You should use load the following recommended settings if they apply to your storage configuration.
+
[role="tabbed-block"]
====
.MetroCluster
...
. To support 4KB aligned I/O with zpools using ONTAP LUNs, verify hte following:
