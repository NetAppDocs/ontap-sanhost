...
---
sidebar: sidebar
permalink: hu_ol_810.html
keywords: host utilities, oracle, linux, 8.10, netapp, ontap
summary: Describes how to use Oracle Linux 8.9 with ONTAP
---
...
== KVM settings
You can also use the <<recommended_settings_ol_810,recommended settings>> to configure a Kernel-based Virtual Machine (KVM). There are no changes required to configure a KVM as the LUN is mapped to the hypervisor.
