...
You can use multipathing with Oracle Linux 7.1 to manage ONTAP LUNs.

[NOTE]
====
* You can use the link:hu_rhel_71.html#rhel-rhck[recommended settings for Red Hat Enterprise Linux (RHEL) 7.1] to configure Red Hat Compatible Kernel for Oracle Linux 7.1.
