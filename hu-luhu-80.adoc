...
[.lead]
The Linux Host Utilities help you manage ONTAP storage attached to a Linux host. When you install the Linux Host Utilities, they don't change any settings on your Linux host. NetApp strongly recommends installing the Linux Host Utilities to improve ONTAP storage management and assist NetApp customer support in gathering information about your configuration. 
