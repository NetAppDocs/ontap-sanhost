---
sidebar: sidebar
permalink: hu-windows-configure-registry-settings.html
...
You need to set FC, NVMe/FC, and iSCSI HBA parameters to optimize performance and successfully handle storage system events. Beginning with Windows Host Utilities 7.2, the installer sets the Windows, FC, iSCSI, and NVMe/FC HBA parameters to the supported values for the Windows host. For Windows Host Utilities 7.1, you need to manually set the iSCSI HBA parameters.
