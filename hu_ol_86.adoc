...
The following sections provide sample multipath outputs for a LUN mapped non-ASA personas.
...
NOTE: To configure Oracle Linux 8.6 RedHat Enterprise Kernel (RHCK), use the link:hu_rhel_86.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 8.6.
