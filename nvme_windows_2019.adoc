...
summary: NVMe/FC Host Configuration for Windows Server 2019 with ONTAP
---
...
[.lead]
You can configure NVMe over Fibre Channel (NVMe/FC) on hosts running Windows Server 2019 and ONTAP as the target.
