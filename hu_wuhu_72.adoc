...
Before you install Host Utilities on the <<supported-windows-versions-72,supported Windows version>>, verify that your host and storage system configuration is supported.
