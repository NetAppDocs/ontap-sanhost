...
summary: Describes how to configure NVMe/FC for SUSE Linux Enterprise Server 15 SPx with ONTAP.
---
...
Learn how to configure NVMe over Fabrics (NVMe-oF) hosts for SUSE Linux Enterprise Server 15 SPx. For more support and feature information, see link:nvme-sles-supported-features.html[ONTAP support and features].
...
. Install SUSE Linux Enterprise Server 15 SPx on the server. After the installation is complete, verify that you are running the specified SUSE Linux Enterprise Server 15 SPx kernel: 
+
[source,cli]
----
uname -r
...
+
----
NVMeTLSkey-1:01:C50ExxxxuOp8xxxxE9EuWjbBxxxxHx4XTqTJUmydf0gIj:
----
...
====
----
nvme subsystem host add -vserver vs_iscsi_tcp -subsystem nvme1 -host-nqn nqn.2014-08.org.nvmexpress:uuid:4c4cxxxx-0035-xxxx-804b-b2cxxxx44d33 -tls-configured-psk NVMeTLSkey-1:01:C50EExxxxuOp8xxxxE9EuWjbBxxxxHx4XTqTJUmydf0gIj:
----
====
...
[source,cli]
----
nvme check-tls-key --identity=1 --subsysnqn=nqn.1992-08.com.netapp:sn.a2d41235b78211efb57dd039eab67a95:subsystem.nvme1 --keydata=NVMeTLSkey-1:01:C50EExxxxuOp8xxxxE9EuWjbBxxxxHx4XTqTJUmydf0gIj: --insert
----
+
...
.. Export the TLS PSK from the kernel keyring. This ensures that the key persists during a host reboot:
+
[source,cli]
----
...
(vserver nvme subsystem controller show)
                  ...
                  Logical Interface: tcpnvme_lif1_1
                               Node: A400-12-181
                           Host NQN: nqn.2014-08.org.nvmexpress:uuid:4c4cxxxx-0035-xxxx-804b-b2c04f444d33
                 Transport Protocol: nvme-tcp
        Initiator Transport Address: 192.168.111.80
