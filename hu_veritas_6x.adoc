...
keywords: host utilities, veritas, infoscale, 6.x, netapp, ontap
summary: Describes how to use Oracle Linux 6.4 with ONTAP
---

= Using Veritas Infoscale 6 for Linux with NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:nofooter:
...
== Introduction
This document provides guidance on ONTAP SAN host configuration settings for the Veritas Infoscale 6 series release for Red Hat Enterprise Linux & Oracle Linux (RHCK based) platforms with FC, FCoE and iSCSI protocols.
