...
NOTE: To configure Oracle Linux 9.2 Red Hat Compatible Kernel (RHCK), use the link:hu_rhel_92.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 9.2.

== KVM settings

You don't need to configure settings for a Kernel-based Virtual Machine on Oracle Linux 9.2 because the LUN is mapped to the hypervisor.
