...
If you continue to have issues, collect the following files and command outputs and contact link:https://mysupport.netapp.com[NetApp support^] for further triage:
