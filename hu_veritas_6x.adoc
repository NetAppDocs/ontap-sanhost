...
[.lead]
You can use ONTAP SAN host configuration settings for the Veritas Storage Foundation 6 series release for Red Hat Enterprise Linux and Oracle Linux (RHCK based) platforms with FC, FCoE and iSCSI protocols.
