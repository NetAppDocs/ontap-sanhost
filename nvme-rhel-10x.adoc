...
In RHEL 10.0, the default iopolicy is round-robin, but queue-depth is available as a configurable option. If you are using RHEL 10.0, you can change the iopolicy to queue-depth by modifying the udev rules file.
