...
+
If the reference `/etc/multipath.conf` file doesn't have the NetApp device specific configuration parameters, add these parameters by using the following customized `.conf drop-in` file. You can find this file under `/etc/multipath/conf.d/`:
+
