...
.Steps
.  Create a SAN boot LUN by following the procedure in the link:https://docs.netapp.com/us-en/ontap/san-management/index.html[Provision SAN storage documentation^].
