...
For Ubuntu 20.04, the `/etc/multipath.conf` file must exist, but you do not need to make specific changes to the file. Ubuntu 20.04 is compiled with all settings required to recognize and correctly manage ONTAP LUNs.
