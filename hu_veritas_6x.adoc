...
You must verify that your configuration meets the system requirements.  For more information, see the https://imt.netapp.com/matrix/#welcome[Interoperability Matrix Tool^] and the Veritas HCL Matrix.
