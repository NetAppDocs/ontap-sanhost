...
NOTE: For more information on the recommended settings, see link:hu-windows-configure-registry-settings.html[Configure registry settings for Windows Host Utilities].
