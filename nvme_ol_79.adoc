...
* There is no sanlun support for NVMe/FC and, as a consequence, no Linux Unified Host Utilities support for NVMe/FC on Oracle Linux 7.9. Use the ONTAP command output available as part of the NetApp plug-in included in the native nvme-cli.
