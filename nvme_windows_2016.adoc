...
summary: NVMe/FC Host Configuration for Windows Server 2016 with ONTAP
---

= NVMe/FC Host Configuration for Windows Server 2016 with ONTAP
:hardbreaks:
:toclevels: 1
:nofooter:
:icons: font
...
[.lead]
You can configure NVMe over Fibre Channel (NVMe/FC) on hosts running Windows Server 2016 using ONTAP as the target.
