...
= Use Red Hat Enterprise Linux 7.9 with ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:nofooter:
...
[.lead]
You can use the ONTAP SAN host configuration settings to configure Red Hat Enterprise Linux 7.9 with ONTAP as the target. 
...
The RHEL 7.9 with ONTAP has the following known issues:
