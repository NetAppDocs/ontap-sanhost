...
RHEL 9.7 sets the default iopolicy for NVMe-oF to `queue-depth`. If you are using RHEL 9.6 and want to change the iopolicy to `queue-depth`, modify the udev rules file as follows:
