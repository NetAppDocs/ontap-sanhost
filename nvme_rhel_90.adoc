...
* Starting RHEL 9.0, in-kernel NVMe multipath is enabled for NVMe namepsaces by default, without the need for explicit settings (unlike RHEL 8).
...
[options="header", cols="20, 20, 20,20"]
|===
|Burt ID |Description |Impacted Functionality |Workaround
|1466602
