...
---
= Configure SUSE Linux Enterprise Server 15 SP5 for FCP and iSCSI with ONTAP storage
:hardbreaks:
:toclevels: 1
:nofooter:
:icons: font
...
You can use multipathing with SUSE Linux Enterprise Server 15 SP5 to manage ONTAP LUNs.
