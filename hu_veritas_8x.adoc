...
To ensure that VxDMP is configured correctly for your host, you need to verify the VxDMP configuration and that the Array Support Library (ASL) and the Array Policy Module (APM) packages for NetApp storage systems were loaded during the Veritas software installation.
