...
. Check the hotfixes required for your Windows Server version in the link:https://docs.netapp.com/us-en/ontap-sanhost/index.html[SAN host Windows documentation].
+
For example, the link:https://review.docs.netapp.com/us-en/ontap-sanhost_pc-fcp-iscsi-improve-ol-7may2025/hu-windows-2025.html[Configure Windows Server 2025 for ONTAP storage] documentation provides instructions on installing Windows hotfixes for Windows Server 2025.
. Add the iSCSI, FCP, or NVMe-oF license and start the target service.

. Verify your cabling.
+
See the https://docs.netapp.com/us-en/ontap/san-config/index.html[SAN configuration reference^] documentation for detailed cabling and configuration information.
