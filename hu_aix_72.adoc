...
The AIX Host Utilities 6.1 release addresses the memory leak issue that was reported in the previous releases. Refer to the link:hu-aix-rn.html[release notes] for additional information.
