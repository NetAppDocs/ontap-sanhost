...
[.lead]
The AIX Host Utilities assists you to manage ONTAP storage attached to an AIX host. The AIX Host Utilities support several AIX environments and multiple transport protocols.
...
+
The NetApp AIX Host Utilities software package is available in a compressed `tar.gz` file.
