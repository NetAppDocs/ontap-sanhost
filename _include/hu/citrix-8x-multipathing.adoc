...
. Locate the `/etc/multipath.conf` file.
+
...
----
====
. The first time you configure multipathing, you might need to enable and start the multipath services to load the recommended settings: 
+
[source,cli]
----
