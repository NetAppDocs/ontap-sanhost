...
[.lead]
You can use the Linux Unified Host Utilities 7.1 sample command reference for an end-to-end validation of the ONTAP storage configuration using the host utilities tool.
