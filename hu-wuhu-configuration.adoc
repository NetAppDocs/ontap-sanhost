...
[NOTE]
====
You need to change the LimTransferSize parameter value after installing Windows Host Utilities 7.2. See <<parameter-72,NVME parameters>>.
...
[[parameter-72]]The Windows Host Utilities installer automatically sets the Windows registry values and the iSCSI and NVMe HBA parameters based on the choices that you make during the installation. Review these values and the operating system version. 
