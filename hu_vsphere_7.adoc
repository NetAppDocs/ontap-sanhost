...
Please provide sample output for this command in a text file [AH]
...
[root@interop-57-131:~] esxcli storage nmp path list -d naa.600a098038313530772b4d673979372f
...
naa.600a098038304759563f4e7837574453
 ...
 [root@rx2530m4-57-228:~] esxcli storage nmp device list -d naa.600a098038304759563f4e7837574453
