...
+
----
# nvme	discovery	-t   tcp    -w	192.168.2.31   -a	192.168.2.25
# nvme	discovery	-t   tcp    -w	192.168.1.31   -a	192.168.1.24
# nvme	discovery	-t   tcp    -w	192.168.2.31   -a	192.168.2.26
# nvme	discovery	-t   tcp    -w	192.168.1.31   -a	192.168.1.25
