...
NOTE: To configure Oracle Linux 7.4 RedHat Enterprise Kernel (RHCK), use the link:hu_rhel_74.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 7.4.
...
NOTE: For Oracle Linux (Red Hat compatible kernel) known issues, see the link:hu_rhel_74.html#known-problems-and-limitations[known issues] for Red Hat Enterprise Linux (RHEL) 7.4.
