...
summary: NVMe/FC Host Configuration for Windows Server 2022 with ONTAP
---

= NVMe/FC Host Configuration for Windows Server 2022 with ONTAP
:hardbreaks:
:toclevels: 1
:nofooter:
:icons: font
...
[.lead]
You can configure NVMe over Fibre Channel (NVMe/FC) on hosts running Windows Server 2022 using ONTAP as the target.

NVMe/FC is supported on ONTAP 9.7 or later for Windows Server 2022.
