...
NOTE: To configure Oracle Linux 6.9 RedHat Enterprise Kernel (RHCK), use the link:hu_rhel_69.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 6.9.
