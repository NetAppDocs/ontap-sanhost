...
.Before you begin
If you decide to use SAN booting, it must be supported by your configuration. You can use the https://mysupport.netapp.com/matrix/imt.jsp?components=74908;74907;&solution=1&isHWU&src=IMT[Interoperability Matrix Tool^] to verify that your OS, HBA, HBA firmware and the HBA boot BIOS, and ONTAP version are supported.
...
NOTE: To configure Oracle Linux 6.8 Red Hat Enterprise Kernel (RHCK), use the link:hu_rhel_68.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 6.8.

== Known issues

There are no known issues for the Oracle Linux 6.8 with ONTAP release.
