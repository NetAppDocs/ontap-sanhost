...
Check whether the configuration is supported with the driver or firmware by referring to link:https://mysupport.netapp.com/matrix/[NetApp Interoperability Matrix Tool^].
...
You can validate NVMe/TCP by using the following procedure.
