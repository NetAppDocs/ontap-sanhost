...
summary: Describes how to use Red Hat Enterprise Linux 8.2 with ONTAP
---
...
For Red Hat Enterprise Linux (RHEL) 8.2 the /etc/multipath.conf file must exist, but you do not need to make specific changes to the file. RHEL 8.2 is compiled with all settings required to recognize and correctly manage ONTAP LUNs.
