...
* Features available:
** Beginning with ONTAP 9.12.1, you can use secure in-band authentication for NVMe-oF with Rocky Linux 9.2.
...
There are no known issues for the NVMe-oF host configuration for Rocky Linux 9.2 with ONTAP release.
