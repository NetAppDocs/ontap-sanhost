...
[.lead]
Features supported for host configuration with NVMe over Fabrics (NVMe-oF) vary based on your version of ONTAP and Rocky Linux.
...
|10 series
|link:nvme-rockylinux-10x.html[Configuring NVMe for Rocky Linux 10.x]
|9 series
|link:nvme-rockylinux-9x.html[Configuring NVMe for Rocky Linux 9.x]
|8 series
|link:nvme-rockylinux-8x.html[Configuring NVMe for Rocky Linux 8.x]
|===
