...
. The native inbox qla2xxx driver included in the OL 9.0 GA kernel has the latest upstream fixes essential for ONTAP support. Verify that you are running the supported adapter driver and firmware versions:
+
----
...
The NVMe-oF host configuration for Oracle Linux 9.0 with ONTAP release has the following known issues:
