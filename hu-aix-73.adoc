...
. Configure the following settings to optimize I/O operations for FC and iSCSI.
+
[role="tabbed-block"]
====
.FCP
...
link:hu-aix-80-command-reference.html[Learn baout the AIX Host Utilties 8.0 sample command reference].
